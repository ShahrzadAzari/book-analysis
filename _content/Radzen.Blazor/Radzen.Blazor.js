...
window.Radzen = {
    loadGoogleMaps: function (defaultView, apiKey, resolve, reject) {
        ...
        defaultView['rz_map_init'] = () => {
            resolveCallbacks.forEach(resolve => resolve(defaultView.google));
        };
        ...
        script.onerror = function(err) {
            rejectCallbacks.forEach(reject => reject(err));
        };
    ...
    updateMap: function (id, zoom, center, markers) {
        if (Radzen[id] && Radzen[id].instance) {
            ...
            if (Radzen[id].instance.markers && Radzen[id].instance.markers.length) {
                Radzen[id].instance.markers.forEach(m => {
                    m.setMap(null);
                });
            }
    ...
    createSlider: function (slider, parent, range, minHandle, maxHandle, min, max, value) {
        slider.mouseMoveHandler = function (e) {
            var newValue = (minHandle == e.target || maxHandle == e.target ? e.target.offsetLeft + e.offsetX : e.offsetX) / parent.offsetWidth * 100;
        ...
        slider.mouseDownHandler = function (e) {
            if (minHandle == e.target || maxHandle == e.target) {
                ...
                var newValue = e.offsetX / parent.offsetWidth * 100;
                var oldValue = range ? value[slider.isMin ? 0 : 1] : value;
